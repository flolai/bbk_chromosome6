...
or chromosomal location is searched.
-------------------------------------------------------------------------------------------------- 
...
users to select any Genbank Accession cell which will take user to summary page of that gene; summary page
...
codon frequency.
============
Program: Search Table CGI script
Author: Maham Ahmad
